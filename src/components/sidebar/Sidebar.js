        ...
        <div className="flip-card-back">
          <ul className="sidebar-nav">
            <li className="sidebar-nav-icons">
              {" "}
              <a
                href="https://github.com/kaptan0428"
                rel="opener noreferrer"
                target="_blank"
            ...
            <li className="sidebar-nav-icons">
              <a
                href="https://www.linkedin.com/in/kaptan-singh-kp"
                rel="opener noreferrer"
                target="_blank"
            ...
            <li className="sidebar-nav-icons">
              <a
                href="https://codeforces.com/profile/KaptanSingh"
                rel="opener noreferrer"
                target="_blank"
                className="fa fas fa-code fa-lg"
              >{null}</a>
            </li>
            <li className="sidebar-nav-icons">
              <a
                href="https://www.codechef.com/users/kaptan_singh"
                rel="opener noreferrer"
                target="_blank"
                className="fa fas fa-code fa-lg"
              >{null}</a>
            ...
            <li className="sidebar-nav-icons">
              {" "}
              <a
                href="mailto:kaptan.singh5084@gmail.com"
                rel="opener noreferrer"
                target="_blank"
